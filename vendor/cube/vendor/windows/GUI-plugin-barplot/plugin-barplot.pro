...
INCLUDEPATH += $${GUI_SRC} $${GUI_SRC}/display $${GUI_SRC}/plugins/Graphwidget-common $${CUBE_SRC}/../\
    $${CUBE_SRC}/../../vpath/src/ \
...
LIBS += -L../cube/release -lcube -L../GUI-qt-core/release -lcube4gui -L../GUI-plugin-graphwidgetcommon/release -lplugin-graphwidgetcommon -LC:/Scalasca-Soft/Misc/regex-2.7-bin/lib -lregex
