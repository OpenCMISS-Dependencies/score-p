...
Section "Start Menu Shortcuts"
  ...
  CreateShortCut  "$SMPROGRAMS\Scalasca\Cube\Cube(scalasca.org).lnk" "$INSTDIR\bin\cube.exe" "" "$INSTDIR\share\icons\cubeicon.ico" 0
  CreateShortCut  "$SMPROGRAMS\Scalasca\Cube\UserGuide.lnk" "$INSTDIR\share\doc\cube\CubeGuide.pdf" "" "" 0
  ...
  CreateShortCut  "$SMPROGRAMS\Scalasca\Cube\GuiPluginDeveloperGuide.lnk" "$INSTDIR\share\doc\cube\CubeGuiPluginDeveloperGuide.pdf" "" "" 0
