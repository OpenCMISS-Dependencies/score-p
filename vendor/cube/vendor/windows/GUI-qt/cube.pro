...
INCLUDEPATH += $${GUI_SRC} $${GUI_SRC}/display $${CUBE_SRC}/../../vpath/src/  $${CUBE_SRC}/../\
	 ...
	 $${CUBE_SRC}/include/ \
	 C:/Work/regex-2.7-bin/include 

LIBS += -L../cube/release -lcube -L../GUI-qt-core/release -lcube4gui  
#LIBS += -L../cube/release -lcube -L../GUI-qt-core/release -lcube4gui -LC:/MinGW/msys/1.0/lib -lregex -lz
RESOURCES =
