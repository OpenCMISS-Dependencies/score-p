...
//   Cube cube;
        ...
        cout << "Checking metrics hash..." << endl;
        cout << met0->get_hash_id() << endl;
        cout << met1->get_hash_id() << endl;
        cout << met2->get_hash_id() << endl;

        cout << "Checking regions hash..." << endl;
        cout << regn0->get_hash_id() << endl;
        cout << regn1->get_hash_id() << endl;
        cout << regn2->get_hash_id() << endl;

        cout << "Checking cnodes hash..." << endl;
        cout << cnode0->get_hash_id() << endl;
        cout << cnode1->get_hash_id() << endl;
        cout << cnode2->get_hash_id() << endl;

        cout << "Checking machines hash..." << endl;
        cout << mach->get_hash_id() << endl;

        cout << "Checking nodes hash..." << endl;
        cout << node->get_hash_id() << endl;

        cout << "Checking processes hash..." << endl;
        cout << proc0->get_hash_id() << endl;
        cout << proc1->get_hash_id() << endl;

        cout << "Checking threads hash..." << endl;
        cout << thrd0->get_hash_id() << endl;
        cout << thrd1->get_hash_id() << endl;
    }
