...
int main(int argc, char* argv[]) {
  ...
  {
	Cube cube1;
	cube1.openCubeReport("/home/roessel/work/scorep/src/tags/REL-2.0.2/vendor/cube/build-backend/../test/test0.0/test0.0.cubex");  /// test of opening cube4 report
	...
	Cube cube2;
	cube2.openCubeReport("/home/roessel/work/scorep/src/tags/REL-2.0.2/vendor/cube/build-backend/../test/test0.0/test0.0.cube");  /// test of opening cube3report 
