...
{
    Metric*  ghostMetric, * normalMetric, * metVisits, * metTime, * metSent, * metRecv;
    Region*  regn0, * regMain, * regInit, * regFinit, * regOp, * regSubOp1, * regSubOp2;
    Cnode*   cnode0, * cMain, * cInit, * cFinit, * cOp, * cSubOp1, * cSubOp2;
    Machine* mach;
    Node*    node;
    Process* p;
    Thread*  t;
