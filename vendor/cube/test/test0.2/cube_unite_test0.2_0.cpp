...
//   Cube cube;
        ...
        // Severity mapping
        TauAtomicValue tau1( 1, 1.234, 1.234, 1.234, 1.522756 );
        TauAtomicValue tau2( 1,  2, 2., 2., 4. );
        TauAtomicValue tau3( 1,  -0.5, -0.5, -0.5, 0.25 );
        TauAtomicValue tau4( 1,  10., 10., 10., 100. );
        TauAtomicValue tau5( 1,  4, 4., 4., 16. );
...
//     cube->set_sev(met0, cnodes_arr[ci], thrd_arr[ti], &tau);
        ...
        ScaleFuncValue sv2( _a );
        ScaleFuncValue sv3( _a );
