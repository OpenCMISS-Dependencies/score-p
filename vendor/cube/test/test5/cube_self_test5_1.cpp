...
{
    Cube cube;
    cout << "Open cube example5.cubex...";
    cube.openCubeReport( "example5.cubex" );
    cout << "done." << endl;
    ...
    cout << v3 << endl;
    double v4 = cube.get_saved_sev( metrics[ 0 ], cnodes[ 100 ], threads[ 12345 ] );
    cout << v4 << endl;
    double v5 = cube.get_saved_sev( metrics[ 1 ], cnodes[ 300 ], threads[ 100 ] );
    cout << v5 << endl;
    return ( v1 = 0. && v2 == 283.82 && v3 == 993 && v4 == 2839 && v5 == 23 ) ? 0 : -1;
}
