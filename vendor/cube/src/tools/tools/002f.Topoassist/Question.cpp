...
intToStr( int number )
{
    ...
    if ( !( ss << number ) )
    {
        throw std::logic_error( "IntToStr failed" );
    }
    return ss.str();
}
...
void
question( int i, std::string q, std::string* a )
{
    /**
...
void
question( int i, std::string q, size_t* a )
{
    /**
...
void
question( std::string q, unsigned int* a )
{
    /**
...
void
question( int i, std::string q, bool* a )
{
    /**
