...
void
AllInMemoryStrategy::addRow( const cnode_id_t rowId, bool& readAllRows, std::vector<cnode_id_t>& rowsToRemove )
{
    rowsToRemove.clear();
...
void
AllInMemoryStrategy::removeRows( std::vector<cnode_id_t>& rowsWantToRemove, std::vector<cnode_id_t>& rowsToRemove )
{
    rowsToRemove.clear();
}
...
void
AllInMemoryStrategy::needRows( std::vector<cnode_id_t>& rowsToAdd, std::vector<cnode_id_t>& rowsToRemoveFirst )
{
