...
void
ManualStrategy::addRow( const cnode_id_t rowId, bool& readAllRows, std::vector<cnode_id_t>& rowsToRemove )
{
    readAllRows = false;
    rowsToRemove.clear();
}
...
void
ManualStrategy::needRows( std::vector<cnode_id_t>& rowsToAdd, std::vector<cnode_id_t>& rowsToRemoveFirst )
{
