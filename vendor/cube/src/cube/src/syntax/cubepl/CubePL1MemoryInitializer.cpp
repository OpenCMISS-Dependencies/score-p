...
#ifndef __CUBEPL1_MEMORY_INITIALIZER_CPP
#define __CUBEPL1_MEMORY_INITIALIZER_CPP 0
...
void
CubePL1MemoryInitializer:: memory_new()
{
    cubepl1_memory_manager->new_page();
}

void
CubePL1MemoryInitializer::memory_cleanup()
{
    cubepl1_memory_manager->throw_page();
}


void
CubePL1MemoryInitializer:: memory_setup( cube::Cube* cube )
{
...
void
CubePL1MemoryInitializer::memory_setup( cube::Metric* metric )
{
    cubepl1_memory_manager->put( cubepl1::CALCULATION_METRIC_ID, 0, metric->get_id(), CUBEPL_VARIABLE  );
}


void
CubePL1MemoryInitializer:: memory_setup( cube::Cnode* cnode )
{
    cubepl1_memory_manager->put( cubepl1::CALCULATION_CALLPATH_ID, 0,  cnode->get_id(), CUBEPL_VARIABLE  );
}


void
CubePL1MemoryInitializer:: memory_setup( cube::Region* region )
{
    cubepl1_memory_manager->put( cubepl1::CALCULATION_REGION_ID, 0,  region->get_id(), CUBEPL_VARIABLE  );
}

void
CubePL1MemoryInitializer::memory_setup(  cube::Sysres* sysres )
{
    cubepl1_memory_manager->put( cubepl1::CALCULATION_SYSRES_ID,   0, sysres->get_id(), CUBEPL_VARIABLE   );
    cubepl1_memory_manager->put( cubepl1::CALCULATION_SYSRES_KIND,   0, sysres->get_kind(), CUBEPL_VARIABLE  );
}
