...
#ifndef __EQUAL_EVALUATION_CPP
#define __EQUAL_EVALUATION_CPP 0
...
EqualEvaluation::EqualEvaluation() : BinaryEvaluation()
{
};

EqualEvaluation::EqualEvaluation( GeneralEvaluation* _arg1,
                                  GeneralEvaluation* _arg2 ) : BinaryEvaluation( _arg1, _arg2 )
{
};


EqualEvaluation::~EqualEvaluation()
{
}

double
EqualEvaluation::eval()
{
...
double
EqualEvaluation::eval( cube::Cnode* _cnode, CalculationFlavour _cf, cube::Sysres* _sf, CalculationFlavour _tf   )
{
...
double
EqualEvaluation::eval( cube::Cnode* _cnode, CalculationFlavour _cf )
{
...
double
EqualEvaluation::eval( double arg1, double arg2  )
{
    return ( ( arguments[ 0 ]->eval( arg1, arg2 ) ) == ( arguments[ 1 ]->eval( arg1, arg2 ) ) ) ? 1. : 0.;
}

double*
EqualEvaluation::eval_row( Cnode*             _cnode,
