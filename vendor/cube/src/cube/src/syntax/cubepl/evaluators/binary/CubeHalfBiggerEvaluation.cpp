...
#ifndef __HALF_BIGGER_EVALUATION_CPP
#define __HALF_BIGGER_EVALUATION_CPP 0
...
double
HalfBiggerEvaluation::eval( cube::Cnode* _cnode, CalculationFlavour _cf, cube::Sysres* _sf, CalculationFlavour _tf   )
{
...
double
HalfBiggerEvaluation::eval( cube::Cnode* _cnode, CalculationFlavour _cf )
{
    return ( ( arguments[ 0 ]->eval( _cnode, _cf ) ) >= ( arguments[ 1 ]->eval( _cnode, _cf ) ) ) ? 1. : 0.;
}

double
HalfBiggerEvaluation::eval( double arg1, double arg2 )
{
...
double*
HalfBiggerEvaluation::eval_row( Cnode*             _cnode,
