 ...
 */
void
AggrCube::get_met_tree( vector<double>& excl_sevv,
 ...
 */
void
AggrCube::get_cnode_tree( vector<double>& excl_sevv,
                          vector<double>& incl_sevv,
                          inclmode        met_mode,
                          inclmode        sys_mode,
                          Metric*         met,
 ...
 */
void
AggrCube::get_sys_tree( vector<double>& excl_sevv,
                        vector<double>& incl_sevv,
                        inclmode        met_mode,
                        inclmode        cnode_mode,
                        Metric*         met,
...
void
AggrCube::get_met_tree( std::map<Metric*, double>& excl_sevv,
                        ...
                        Sysres* sys )
{
//    map<Metric*, double>::iterator excl_it = excl_sevv.begin();
//    map<Metric*, double>::iterator incl_it = incl_sevv.begin();
...
//     {
//     #pragma omp for
    for ( int i = 0; i < ( int )num_metrics; ++i )
    {
...
void
AggrCube::get_reg_tree( vector<double>& excl_sevv,
                        vector<double>& incl_sevv,
...
void
AggrCube::get_reg_tree( std::map<Region*, double>& excl_sevv,
                        ...
                        Sysres* sys )
{
//    map<Region*, double>::iterator excl_it = excl_sevv.begin();
//    map<Region*, double>::iterator incl_it = incl_sevv.begin();
//    map<Region*, double>::iterator diff_it = diff_sevv.begin();
...
double
AggrCube::get_vcsev( inclmode met_mode,
                     inclmode cnode_mode,
                     inclmode sys_mode,
                     Metric*  met,
                     Cnode*   cnode,
...
double
AggrCube::get_vrsev( inclmode met_mode,
                     inclmode reg_mode,
                     inclmode sys_mode,
                     Metric*  met,
                     Region*  reg,
...
double
AggrCube::get_esev( Metric* met, Cnode* cnode, Sysres* sys )
{
...
double
AggrCube::get_rmet_sev( Metric* met )
{
    if ( met == NULL )
    {
        return 0.0;
