...
//     int    sys_res = 0;
    ...
    std::pair<
        std::multimap<const Sysres*, std::vector<long> >::const_iterator,
        std::multimap<const Sysres*, std::vector<long> >::const_iterator > range;
    std::multimap<const Sysres*, std::vector<long> >::const_iterator       range_iter;
