...
double*
transform_values_to_doubles( cube::Value * *v, size_t );

char*
transform_values_to_raw( cube::Value * *row, cube::Value * v, size_t );

cube::Value**
transform_raw_to_values( char*, cube::Value *, size_t );

cube::Value**
transform_doubles_to_values( double*, cube::Value *, size_t );



template <class T>
char*
transform_doubles_to_t( double* row, size_t size )
{
...
double*
transform_raw_to_doubles( char*, cube::Value *, size_t );

inline
char*
transform_doubles_to_raw( double* row )
{
    return ( char* )row;
}
