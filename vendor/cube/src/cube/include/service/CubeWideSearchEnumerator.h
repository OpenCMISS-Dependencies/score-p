...
{
/**
 *  DeepSearchEnumerator delivers a row of IdentObject's, started with \param root according the "wide search " prescription; Used in InclusiveMetric.
 */
...
protected:
    ...
    traverse( row_of_objects_t*,
              cube::Vertex* );                                                // /< Runs over the tree like "wide search" and assignd id's
};
}
#endif
