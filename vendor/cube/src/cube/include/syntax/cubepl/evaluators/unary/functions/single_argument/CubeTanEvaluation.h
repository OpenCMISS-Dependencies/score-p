...
#ifndef __TAN_EVALUATION_H
#define __TAN_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"
namespace cube
{
class TanEvaluation : public UnaryEvaluation
{
public:
    TanEvaluation();
    TanEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
