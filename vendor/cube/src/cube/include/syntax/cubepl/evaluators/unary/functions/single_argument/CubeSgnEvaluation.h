...
#ifndef __SGN_EVALUATION_H
#define __SGN_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"
namespace cube
{
class SgnEvaluation : public UnaryEvaluation
{
public:
    SgnEvaluation();
    SgnEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
