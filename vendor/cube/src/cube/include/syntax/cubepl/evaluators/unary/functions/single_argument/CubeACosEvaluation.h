...
#ifndef __ACOS_EVALUATION_H
#define __ACOS_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"

namespace cube
{
class ACosEvaluation : public UnaryEvaluation
{
public:
    ACosEvaluation();
    ACosEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
    virtual
    ~ACosEvaluation();
