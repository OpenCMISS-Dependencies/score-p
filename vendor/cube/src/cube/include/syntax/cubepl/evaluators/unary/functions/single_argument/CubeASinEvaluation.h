...
#ifndef __ASIN_EVALUATION_H
#define __ASIN_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"

namespace cube
{
class ASinEvaluation : public UnaryEvaluation
{
public:
    ASinEvaluation();
    ASinEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
