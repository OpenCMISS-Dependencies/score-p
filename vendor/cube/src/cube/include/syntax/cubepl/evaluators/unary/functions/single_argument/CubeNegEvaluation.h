...
#ifndef __NEG_EVALUATION_H
#define __NEG_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"
namespace cube
{
class NegEvaluation : public UnaryEvaluation
{
public:
    NegEvaluation();
    NegEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
