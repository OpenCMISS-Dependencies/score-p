...
#ifndef __SIN_EVALUATION_H
#define __SIN_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"

namespace cube
{
class SinEvaluation : public UnaryEvaluation
{
public:
    SinEvaluation();
    SinEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
