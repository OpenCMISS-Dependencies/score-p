...
#ifndef __SQRT_EVALUATION_H
#define __SQRT_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"

namespace cube
{
class SqrtEvaluation : public UnaryEvaluation
{
public:
    SqrtEvaluation();
    SqrtEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
