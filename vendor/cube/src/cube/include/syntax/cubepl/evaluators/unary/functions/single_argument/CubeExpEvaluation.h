...
#ifndef __EXP_EVALUATION_H
#define __EXP_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"
namespace cube
{
class ExpEvaluation : public UnaryEvaluation
{
public:
    ExpEvaluation();
    ExpEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
    virtual
    ~ExpEvaluation();
