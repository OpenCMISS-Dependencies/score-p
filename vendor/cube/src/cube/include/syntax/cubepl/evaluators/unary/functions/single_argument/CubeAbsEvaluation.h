...
#ifndef __ABS_EVALUATION_H
#define __ABS_EVALUATION_H 0

#include "CubeUnaryEvaluation.h"

namespace cube
{
class AbsEvaluation : public UnaryEvaluation
{
public:
    AbsEvaluation();
    AbsEvaluation( GeneralEvaluation* _arg ) : UnaryEvaluation( _arg )
    {
    };
    virtual
    ~AbsEvaluation();
