...
#define CUBE_LIBRARY_VERSION_KEY "CUBE Library version"
...
#define CUBE_VERSION_KEY "Cube Version"
#define CUBE_ANCHOR_VERSION_KEY "Cube anchor.xml syntax version"
#define CUBE_XML_VERSION_KEY "Cube syntax version"
#define CUBE_ANCHOR_VERSION "4.4"
 ...
 */
    ...
    Metric*
        get_met( uint32_t ) const;                                                              // /< Returns a metric with given id or NULL.
...
// ----------------- basic one -------------------
    ...
    /**
     * Saves row of values "as it is... swwithout any conversation... used for fast copy"
     */
    void
...
// ----  additional calls, which might replace all others
    ...
    Value*
    get_sev_adv( list_of_sysresources& sys_res );
    double
    get_sev( list_of_sysresources& sys_res );
...
// ------ additinal writing ----------------
    ...
    writeXML_header( std::ostream&,
                     bool cube3_export,
                     bool write_ghost_metrics = false
                     );                          // /< Writes a meta part in the cube3 file or a metafile of cube4. cube3_export signalize, that one exports into cube3 format.
    void
...
//
    ...
    std::vector<char>
    get_misc_data( std::string& dataname );                            // /< Returns a std::vector with the content of the file "dataname" if present, otherwise empty;
    void
 ...
 */
     ...
     */
//     Cartesian*   def_cart(Cartesian * _topo, std::map< Thread*, Thread*> & thread_map);
