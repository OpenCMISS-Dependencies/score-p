 ...
 */
    ...
    char*                  aggr_plus_expression;        /** only derivated metrics do carry here the initiallization expression for the calculation. Another metrics ignore this field. */
    char*                  aggr_minus_expression;       /** only derivated metrics do carry here the initiallization expression for the calculation. Another metrics ignore this field. */
...
enum bool_t
__cube_metric_data_type_compatible( enum DataType,
                                    enum CubeMetricType );               /** compared data type and metric type if compatible*/
