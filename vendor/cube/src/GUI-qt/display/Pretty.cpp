...
double
zdistz( double umina, double umaxa, int na )
{
    int n = na > 1 ? na : 1;
    //int n = max(na, 1);
...
RangeHelper
zulimz( double umin, double umax, double dist )
{
...
RangeHelper
zuintz( double umina, double umaxa, int npa )
{
...
void
Pretty( double pmin, double pmax, int pno, vector<double>& vec )
{
